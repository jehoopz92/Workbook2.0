function exportMe() {
    ...
    window.location=('mailto:cdiaz@uste3.com; aestrada@uste3.com; corpus.warehouse@conns.com; daniel.soliz@conns.com; blas.rodriguez@conns.com;jhurley@uste3.com;aleplatt@uste3.com;jemery@uste3.com;spowell@uste3.com?Subject=Conns Corpus Christi Export for '+date+' with an average of '+average+'&body=Corpus Christi has been exported with '+trucks+' trucks, '+stops+' stops and '+piece+' pieces. Please refresh DT and let me know when drivers are assigned, thank you!');
    roundDown();
}
...
function unresolved() {
    ...
    window.location=('mailto:cdiaz@uste3.com; aestrada@uste3.com; corpus.warehouse@conns.com; daniel.soliz@conns.com; blas.rodriguez@conns.com;crystal.welch@conns.com; jhurley@uste3.com;aleplatt@uste3.com;jemery@uste3.com;spowell@uste3.com?subject=Conns Corpus Christi Unresolved Address '+date+'&body= Good Evening, we are unable to locate the following address for the following order numbers '+test+'.  Could someone reach out to the customer and let us know where to pin this stop on the map? Cross streets, name of the subdivision or apartment complex are the most helpful identifiers but any sort of directions would help.');
}
